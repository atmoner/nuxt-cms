    ...
    <div class="flex h-screen">
      ...
      <aside class="w-64 bg-gray-900 text-white">
        ...
        <div class="mt-auto p-4 border-t border-gray-800">
          <div class="flex items-center justify-between">
            ...
            <button
              class="ml-3 p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-200"
      ...
      <main class="flex-1 p-6 bg-gray-100 overflow-auto">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          >
            <div class="animate-spin rounded-full h-8 w-8 border-4 border-indigo-200 border-t-indigo-600 mx-auto" />
          ...
          >
            ...
            <p class="text-sm">
              Cliquez sur "Nouvelle page" pour commencer
            </p>
          </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <NuxtLink
                    :to="`/nuxt-cms/admin/page-edit?id=${page.id}`"
...
const deletePage = async (page) => {
  ...
  try {
    await $fetch(`/api/nuxt-cms/pages/${page.id}`, {
      method: 'DELETE',
    })
    await loadPages()
  }
